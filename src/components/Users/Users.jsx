        ...
        props.usr.map(uElement =>
          <div key={uElement.id}>
            <span>
              ...
              <div>
                {uElement.followed ?
                  <button disabled={(uElement.id === props.isTID) ? true : false} onClick={() => props.onF(uElement.id, false)}>Unfollow</button> :
                  <button disabled={(uElement.id === props.isTID) ? true : false} onClick={() => props.onF(uElement.id, true)}>Follow</button>}
              </div>
            </span>
