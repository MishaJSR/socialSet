...
const reducerUsers = (state = initialState, action) => {
  switch (action.type) {
    ...
    case FOLLOW: {
      // state.usersPage[action.userId].friend = true;
      // state.usersPage[action.userId].status = "yyy"; 
      return {
        ...state,
    ...
    case UNFOLLOW: {
      // state.usersPage[action.userId].friend = false;
      // state.usersPage[action.userId].status = "nnnn";
      return {
        ...state,
        usersPage: state.usersPage.map(u => {
          if (u.id = action.userId){
